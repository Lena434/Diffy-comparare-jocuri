    ...
    return (
      <div style={{ minHeight: "100vh", padding: "80px 24px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center", maxWidth: "500px" }}>
          <div style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "3rem", color: "var(--arcade-shadow)", marginBottom: "20px" }}>✖</div>
          <h1 style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.7rem", color: "var(--arcade-h)", textShadow: "2px 2px 0px var(--arcade-h-shadow)", marginBottom: "16px", lineHeight: 1.8 }}>
            GAME NOT FOUND
          </h1>
          <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.38rem", color: "var(--arcade-muted)", marginBottom: "30px", lineHeight: 1.8 }}>
    ...
    <div style={{ minHeight: "100vh", padding: "80px 24px 40px" }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        <button
          ...
          style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.45rem", cursor: "pointer", marginBottom: "30px", display: "inline-flex", alignItems: "center", gap: "8px", padding: "9px 18px", letterSpacing: "0.06em" }}
        >
          <span>◄</span>
          <span>BACK</span>
        </button>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(300px, 100%), 1fr))", gap: "30px", marginBottom: "50px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px", justifyContent: "space-between" }}>
            <h1 style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "clamp(0.8rem, 3vw, 1.4rem)", color: "var(--arcade-h)", textShadow: "3px 3px 0px var(--arcade-h-shadow)", letterSpacing: "0.08em", margin: 0, lineHeight: 1.6 }}>
              {game.title}
            </h1>

            <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.55rem", color: "var(--arcade-text)", letterSpacing: "0.04em", lineHeight: 2.1, margin: 0 }}>
              {game.description}
            </p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "16px", background: "var(--arcade-panel)", border: "3px solid var(--arcade-border)", padding: "20px", boxShadow: "4px 4px 0px var(--arcade-shadow)" }}>
              <div style={{ gridColumn: "1 / -1" }}>
                <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.42rem", color: "var(--arcade-muted)", marginBottom: "10px" }}>GENRE</p>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                  {game.genres.map((genre) => <GenreBadge key={genre} genre={genre} size="md" />)}
                </div>
              </div>
              <div>
                <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.42rem", color: "var(--arcade-muted)", marginBottom: "8px" }}>PLATFORM</p>
                <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.45rem", color: "var(--arcade-text)", margin: 0 }}>{game.platforms.join(', ')}</p>
              </div>
              <div>
                <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.42rem", color: "var(--arcade-muted)", marginBottom: "8px" }}>MODE</p>
                <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.45rem", color: "var(--arcade-text)", margin: 0 }}>{game.gameModes.join(', ')}</p>
              </div>
              <div>
                <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.42rem", color: "var(--arcade-muted)", marginBottom: "8px" }}>YEAR</p>
                <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.45rem", color: "var(--arcade-text)", margin: 0 }}>{game.releaseYear}</p>
              </div>
              {game.price !== undefined && (
                <div>
                  <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.42rem", color: "var(--arcade-muted)", marginBottom: "8px" }}>PRICE</p>
                  <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.58rem", color: "var(--arcade-h)", margin: 0 }}>{game.price === 0 ? 'FREE' : `$${game.price.toFixed(2)}`}</p>
                </div>
              )}
              {game.developer && (
                <div>
                  <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.42rem", color: "var(--arcade-muted)", marginBottom: "8px" }}>DEVELOPER</p>
                  <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.45rem", color: "var(--arcade-text)", margin: 0 }}>{game.developer}</p>
                </div>
              )}
              {game.publisher && (
                <div>
                  <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.42rem", color: "var(--arcade-muted)", marginBottom: "8px" }}>PUBLISHER</p>
                  <p style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "0.45rem", color: "var(--arcade-text)", margin: 0 }}>{game.publisher}</p>
                </div>
              )}
            </div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "12px" }}>
              <button
                ...
                style={{ flex: "1 1 200px", borderWidth: "3px", borderStyle: "solid", fontFamily: "'Press Start 2P', monospace", fontSize: "0.45rem", padding: "14px 20px", cursor: "pointer", letterSpacing: "0.06em", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  flex: "1 1 200px", borderWidth: "3px", borderStyle: "solid", fontFamily: "'Press Start 2P', monospace", fontSize: "0.45rem", padding: "14px 20px", cursor: "pointer", letterSpacing: "0.06em", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px",
        ...
        {similarGames.length > 0 && (
          <div>
            <div style={{ textAlign: "center", marginBottom: "30px", borderTop: "2px dashed var(--arcade-shadow)", paddingTop: "40px" }}>
              <h2 style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "clamp(0.6rem, 2vw, 0.9rem)", color: "var(--arcade-h)", textShadow: "2px 2px 0px var(--arcade-h-shadow)", letterSpacing: "0.1em", margin: 0 }}>
                ▸ SIMILAR GAMES
              </h2>
            </div>
