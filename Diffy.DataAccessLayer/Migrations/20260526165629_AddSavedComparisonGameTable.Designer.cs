...
namespace Diffy.DataAccessLayer.Migrations
{
    ...
    [Migration("20260526165629_AddSavedComparisonGameTable")]
    partial class AddSavedComparisonGameTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Diffy.Domain.Entities.User.SavedComparisonGameEntity", b =>
                {
                    b.Property<int>("SavedComparisonId")
                        .HasColumnType("integer");

                    b.Property<int>("GameId")
                        .HasColumnType("integer");

                    b.HasKey("SavedComparisonId", "GameId");

                    b.HasIndex("GameId");

                    b.ToTable("SavedComparisonGames");
                });
            ...
            modelBuilder.Entity("Diffy.Domain.Entities.User.SavedComparisonGameEntity", b =>
                {
                    ...
                    b.HasOne("Diffy.Domain.Entities.User.SavedComparisonEntity", "SavedComparison")
                        .WithMany("SavedComparisonGames")
                        .HasForeignKey("SavedComparisonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Game");

                    b.Navigation("SavedComparison");
                });
            ...
            modelBuilder.Entity("Diffy.Domain.Entities.User.SavedComparisonEntity", b =>
                {
                    b.Navigation("SavedComparisonGames");
                });
